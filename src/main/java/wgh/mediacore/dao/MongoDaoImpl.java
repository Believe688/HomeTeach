...
public class MongoDaoImpl implements MongoDao {
     ...
     */
    @Override
    public Boolean updateDoc(Query query, Update update, @NonNull Class object, Boolean isAll) {
        try {
            if (isAll) {
                mongoTemplate.updateMulti(query, update, object);
            } else {
                mongoTemplate.updateFirst(query, update, object);
            }
        } catch (Exception e) {
